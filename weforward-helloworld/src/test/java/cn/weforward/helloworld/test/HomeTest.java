package cn.weforward.helloworld.test;
...
public class HomeTest {
	...
	public void init() throws IOException {
		...
		String preUrl = result.getProperty("honinyun.apiUrl");
		String accessId = result.getProperty("hyservice.accessId");
		String accessKey = result.getProperty("hyservice.accessKey");
		String serviceName = result.getProperty("hyms.name");
